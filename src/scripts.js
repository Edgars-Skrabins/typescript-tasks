...
var getTypeOf = function (obj) { return typeof (obj); };
...
var compareValuesAndTypes = function (a, b) {
    return a === b;
};
...
var getNthCharOfString = function (word, index) {
...
// Return the result
var removeFirst3Characters = function (a) {
...
// Return the result
var getLast3Characters = function (a) {
...
// Return the result
var getFirst3Characters = function (a) {
    return a.slice(0, 3);
};
...
// Return the result
var getFirstHalfOfString = function (a) {
...
// Return the result
var removeLast3Characters = function (a) {
...
// Tip: mind the order
var bunchOfMathStuff = function (a, b, c, d, e, f) {
    var sum = a + b;
    var subtraction = sum - c;
    var multiplication = subtraction * d;
    var division = multiplication / e;
...
var checkIfNumberEven = function (a) {
    return a % 2 === 0;
};
...
var getCharAmountInString = function (a, b) {
    var amountOfChar = 0;
...
var ifSmallerDivideOtherwiseMultiply = function (a, b) {
    if (a < b) {
        return a / b;
    }
    else {
...
var doThingsIfContains = function (a, b) {
    if (a.includes(b)) {
        return b + a;
    }
    else {
...
var roundTo2DigitDecimal = function (a) {
...
var splitIntoIndividualDigits = function (a) {
    var digitsString = a.toString();
    var digits = Array.from(digitsString, Number);
    return digits;
};
...
var formJsCountrysideDowntownString = function (a, b) {
    var sentenceWords = ["Javascript", "Countryside", "Downtown"];
    var firstWord = a.replace(/%/g, '');
    var secondWord = b.replace(/%/g, '');
...
var isPrime = function (a) {
    var currentNumber = a;
    for (var i = 2, s = Math.sqrt(currentNumber); i <= s; i++) {
...
var divisibleHigherNatural = function (x, y) {
    if (x % y === 0) {
        return x;
    }
    else {
...
var twoStringDoingThings = function (a, b) {
    var result = '';
...
var incrementOneRelativeToAlphabet = function (a) {
    var aArray = a.split("");
...
var getNextLetterInAlphabet = function (a) {
...
var getElementInArrayByIndex = function (a, b) {
    return a[b - 1];
};
...
// Return the result
var removeFirst3FromArray = function (a) {
    return a.slice(3, a.length);
};
...
var get3LastFromArray = function (a) {
    return a.slice(a.length - 3, a.length);
};
...
// Return the resulting array
var get3FirstFromArray = function (a) {
    return a.slice(0, 3);
};
console.log("----- Task 27 -----");
...
// Extract the first 3 elements of a
// Return the resulting array
var returnLastNArrayElements = function (a, n) {
...
var getArrayElementCount = function (a) {
    return a.length;
};
console.log("----- Task 30 -----");
...
var getArrayNegativeNumberCount = function (a) {
    var count = 0;
    for (var i = 0; i < a.length; i++) {
        if (a[i] < 0) {
            count += 1;
...
var sortArrayDescending = function (a) {
...
// Return the result
var getSortedAlphabeticalStringArray = function (a) {
    return a.sort();
};
console.log("----- Task 33 -----");
...
var getAverageInArray = function (a) {
    var sum = 0;
    for (var i = 0; i < a.length; i++) {
        sum += a[i];
    }
...
var getLongestString = function (a) {
    var longestString = "";
    for (var i = 0; i < a.length; i++) {
...
var checkIfArrayElementsAreEqual = function (a) {
    var comparisonElement = a[0];
    for (var i = 0; i < a.length; i++) {
...
var returnManyArrays = function () {
    var a = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        a[_i] = arguments[_i];
    }
    return a.reduce(function (result, arr) { return result.concat(arr); }, []);
};
console.log("----- Task 37 -----");
...
var sortObjArrayAscending = function (a) {
    return a.sort(function (objA, objB) { return objA.b - objB.b; });
};
console.log("----- Task 38-----");
...
var mergeArrays = function (a, b) {
    var mergedArray = a.concat(b).filter(function (value, index, self) { return self.indexOf(value) === index; });
    return mergedArray;
};
console.log("----- Task 39-----");
...
// Return the sum
var sumGreaterThanB = function (a, b) {
    var sum = 0;
    for (var i = 0; i < a.length; i++) {
        if (a[i] > b) {
            sum += a[i];
...
var getMinMaxNumbers = function (a, b) {
    var newArray = [];
    for (var i = a; i <= b; i++) {
        newArray.push(i);
    }
...
var getObjectSortedStringNames = function (a) {
    var grouped = {};
    for (var _i = 0, a_1 = a; _i < a_1.length; _i++) {
        var str = a_1[_i];
        var firstLetter = str.charAt(0).toLowerCase(); // Normalize to lowercase
...
var getArbitraryArray = function (a, b) {
    var newArray;
    if (b < 6) {
        newArray = [0];
    }
...
var saveNthElementInArray = function (a, b) {
    var newArray = [];
    for (var i = b - 1; i < a.length; i += b) {
        newArray.push(a[i]);
    }
    return newArray;
};
...
var getObjSpecificProperty = function (a, b) {
    return a[b];
};
console.log("----- Task 47-----");
...
var checkIfObjHas = function (a, b) {
...
// Return the object
var createObjWithValue = function (a, b) {
    var myObj = { a: b };
    return myObj;
};
console.log("----- Task 50-----");
...
var createObjOutOfArray = function (a, b) {
    var myObj = {};
    for (var i = 0; i < a.length; i++) {
        myObj[a[i]] = b[i];
    }
...
var getAllObjKeysSum = function (a) {
    var numArray = Object.values(a);
    var sum = 0;
...
var getObjWithoutKeyB = function (a) {
    var result = {};
    for (var key in a) {
        if (key !== 'b') {
            result[key] = a[key];
...
var mergeObjects = function (a, b) {
    var mergedObject = __assign(__assign({}, a), b);
...
// Return the resulting object
var multiplyObjValues = function (a, b) {
    var newObj = {};
    for (var key in a) {
        newObj[key] = a[key] * b;
    }
...
var swapObjKeysWithValues = function (a) {
    var newObj = {};
    for (var key in a) {
...
// Return the resulting object
var getObjWithNullEmptyString = function (a) {
    var newObj = {};
    for (var key in a) {
        var value = a[key].trim();
...
// Replace empty strings and strings that contain only whitespace with null values
// Return the resulting object
var getObjNames = function (obj) {
    var newObj = {
        fn: obj.fn,
        ln: obj.ln
    };
    if (obj.size !== undefined) {
        newObj.size = "".concat(obj.size, "cm");
    }
    if (obj.weight !== undefined) {
        newObj.weight = "".concat(obj.weight, "kg");
    }
    return newObj;
};
console.log("----- Task 59 -----");
...
var getObjPersonalInfo = function (a) {
    var newObj = {
        fn: a.fn,
        ln: a.ln
    };
...
var getFavoriteMovieObj = function (a, b) {
    return __assign(__assign({}, a), { b: b });
};
console.log("----- Task 69 -----");
